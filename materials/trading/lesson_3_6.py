...
def how_long(func, *args):
    """Execute function with given argument, and measure execution time"""
    t0 = time()
...
def test_run():
    ...
    print(res_manual)
    print(res_numpy)
    print("Manual: {:.6f} ({:.3f} secs.) vs NumPy {:.6f} ({:.3f} secs.)".format(res_manual, res_manual/1000, res_numpy, res_numpy/1000))
